...
- **Email:** rodriguezsamuelj@gmail.com
- **LinkedIn:** [Perfil LinkedIn](https://www.linkedin.com/in/samuel-rodríguez-ramírez-9175a4150)
...
## Experiencia Laboral
### Desarrollador Full Stack | Zio Analytics / TWINS
*ENERO 2023 – ENERO 2026*

Startup del sector marketing y análisis de datos.
- Desarrollo completo de plataforma SaaS.
- Responsable del backend y frontend de la aplicación.
- Gestión de base de datos.
- Integración con APIs externas.
- Despliegue, mantenimiento y gestión de logs en servidores Linux.
- Refactorización continua y mejora del rendimiento.

### Desarrollador Full Stack | Delta Gestión y Control de Sistemas SL
*MARZO 2022 – DICIEMBRE 2022*
- Desarrollo de aplicaciones web.
- Desarrollo de sitios web corporativos en WordPress.
